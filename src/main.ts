...
import { winstonLogger } from '@/commons/logger/winston.util';
...
import { CustomExceptionFilter } from '@/commons/filters/custom-exception.filter';
...
async function bootstrap() {
  ...
  setupSwagger(app, appName, prefix);
